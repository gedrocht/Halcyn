...
try {
  & $python.Source -m mypy desktop_visualizer_operator_console desktop_shared_control_support
  if ($LASTEXITCODE -ne 0) {
...
Write-Host 'Visualizer Studio type checks completed successfully.'
