...
Write-InstallHint -Name 'python-sounddevice' -IsAvailable $pythonSoundDeviceAvailable -Hint 'Needed for real desktop audio capture, especially output-loopback capture. Install with: python -m pip install sounddevice'
