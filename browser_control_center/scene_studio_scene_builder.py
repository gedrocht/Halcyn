"""Scene-generation helpers for the browser-based Scene Studio."""
...
class PresetDefinition:
    """Describe one Scene Studio preset and its default controls."""
...
SOURCE_CATALOG: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "name": "Microphone",
        "description": (
            "Browser-side microphone analysis routed into level and rough frequency bands."
        ),
    },
    {
        "id": "manual",
